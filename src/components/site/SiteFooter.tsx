    ...
    <footer className="bg-navy-deep text-navy-foreground">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-navy-foreground/70">
            ...
            <li>
              <Link to="/" hash="testimonials" className="hover:text-navy-foreground">
                Reader stories
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-navy-foreground/70">
            ...
            <li>
              <a href="mailto:partners@affiliatex.co" className="hover:text-navy-foreground">
                Advertise with us
              </a>
            </li>
          </ul>
      ...
      <div className="border-t border-navy-foreground/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-5 text-xs text-navy-foreground/60 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>Made for affiliate marketers, weekly.</p>
        </div>
      </div>
    </footer>
  );
