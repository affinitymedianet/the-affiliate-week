      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-4 md:grid-cols-[auto_1fr] md:gap-12">
        ...
        <div>
          ...
          <div className="mt-4 space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              AffiliateX is written by an operator, not a content team. Everything in an issue is
              read and filtered by a person before it goes in — if a week is quiet, the issue is
              short. We don't pad it with press releases.
            </p>
            <p>
