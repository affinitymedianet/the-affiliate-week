...
('Free tier extended to 25k monthly clicks', 'RedTrack', 'Tracking', 'Free trial', 'Extended free tier', 'A larger free allowance while you validate your first campaigns.', 'RedTrack is a conversion tracker and attribution tool used across affiliate, agency and e-commerce setups. Instead of the standard trial, AffiliateX readers get an extended allowance of 25,000 tracked clicks per month for the first 90 days, which is enough to validate several offers before committing.', NULL, 'https://redtrack.io/', true, false, '2026-12-15'),
